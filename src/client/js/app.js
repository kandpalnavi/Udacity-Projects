...
export const updateUI = ({rh, name, pres, temp, precip, webformatURL, description, forecastDate, countryName, capital, currencies, currSymb, languages, population, flag}) => {
    ...
    if(name == 'invalid') {
        errorEl.innerHTML = '<i class="fas fa-exclamation-triangle"></i>City could not be recognized by GeoNames. Please try again!'
